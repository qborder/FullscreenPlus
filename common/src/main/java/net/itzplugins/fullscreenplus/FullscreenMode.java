...
public enum FullscreenMode implements StringIdentifiable {
    ...
    EXCLUSIVE_BORDERLESS(2, "fullscreenplus.mode.exclusive_borderless");

    public static final Codec<FullscreenMode> CODEC = StringIdentifiable.createCodec(FullscreenMode::values);
    private static final IntFunction<FullscreenMode> BY_ID = ValueLists
            .createIndexToValueFunction(FullscreenMode::getId, values(), ValueLists.OutOfBoundsHandling.WRAP);
